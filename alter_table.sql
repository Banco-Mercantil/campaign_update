...
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.int_metas__individuais ADD COLUMN meta_cartao NUMBER(38,0);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.int_metas__individuais ADD COLUMN meta_individ_crt_consig_dia NUMBER(38,0);
SELECT meta_individ_crt_consig_dia FROM sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.int_metas__individuais; 
...
SELECT rlz_elegibilidade_app_mb FROM sdx_excelencia_comercial.camp_incentivo__bemaqui_apurac.mrt_apuracao__individual;
    --camp_incentivo__bemaqui_historico
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__individual ADD COLUMN producao_efetivada_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__individual ADD COLUMN producao_desconsiderada_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__individual ADD COLUMN producao_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__individual ADD COLUMN meta_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__individual ADD COLUMN rlz_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__individual ADD COLUMN rlz_elegibilidade_app_mb NUMBER(10,2);
SELECT rlz_elegibilidade_app_mb FROM sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__individual;
...
SELECT rlz_elegibilidade_app_mb FROM sdx_excelencia_comercial.camp_incentivo__bemaqui_apurac.mrt_apuracao__agencia;
    --camp_incentivo__bemaqui_historico
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__agencia ADD COLUMN producao_efetivada_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__agencia ADD COLUMN producao_desconsiderada_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__agencia ADD COLUMN producao_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__agencia ADD COLUMN meta_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__agencia ADD COLUMN rlz_crt_consignado NUMBER(10,2);
ALTER TABLE sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__agencia ADD COLUMN rlz_elegibilidade_app_mb NUMBER(10,2);
SELECT rlz_elegibilidade_app_mb FROM sdx_excelencia_comercial.camp_incentivo__bemaqui_historico.mrt_apuracao__agencia;
